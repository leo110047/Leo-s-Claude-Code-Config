...
$GOLDBAND_BIN/goldband-timeline-log '{"skill":"open-goldband-browser","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
. "$HOME/.claude/skills/goldband/bin/goldband-env" || exit $?
$GOLDBAND_BIN/goldband-question-log '{"skill":"open-goldband-browser","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
...
. "$HOME/.claude/skills/goldband/bin/goldband-env" || exit $?
_EXT_PATH=""
[ -z "$_EXT_PATH" ] && [ -f "$GOLDBAND_ROOT/extension/manifest.json" ] && _EXT_PATH="$GOLDBAND_ROOT/extension"
