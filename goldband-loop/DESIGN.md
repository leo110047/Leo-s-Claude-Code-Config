# Design System — goldband

## Product Context
- **What this is:** Community website for goldband — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering goldband, existing community members
