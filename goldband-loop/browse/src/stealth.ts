 ...
 *
 *   2. EXTENDED (opt-in via GOLDBAND_STEALTH=extended): six additional
...
function extendedModeEnabled(): boolean {
  const v = process.env.GOLDBAND_STEALTH;
 ...
 * EXTENDED_STEALTH_SCRIPT when GOLDBAND_STEALTH=extended.
 */
