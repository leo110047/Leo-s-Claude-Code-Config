// Allowlist file at ~/.goldband/ios-qa-allowlist.json. The single source of
...
export function defaultAllowlistPath(): string {
  return process.env.GOLDBAND_IOS_ALLOWLIST_PATH
    ?? join(homedir(), '.goldband', 'ios-qa-allowlist.json');
}
