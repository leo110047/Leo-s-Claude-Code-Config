...
export interface EnsureDaemonOptions {
   ...
   * DESIGN_DAEMON_STATE_FILE or .goldband/design.json under the git root /
    ...
    if (health) {
      ...
      if (health.activeBoards > 0) {
        process.stderr.write(
          `[design-daemon] WARNING: existing daemon is goldband ${health.version}; this CLI is ${expectedVersion}.\n` +
