#!/usr/bin/env bun
/**
 * goldband-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   goldband-global-discover --since 7d [--format json|summary]
 *   goldband-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: goldband-global-discover --since <window> [--format json|summary]
...
Examples:
  goldband-global-discover --since 7d
  goldband-global-discover --since 14d --format summary`);
}
...
function resolveClaudeCodeCwd(
  ...
  // e.g., /Users-example-git-repo → /Users/example/git/repo
