...
~/.claude/skills/goldband/bin/goldband-timeline-log '{"skill":"benchmark-models","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
BIN="$HOME/.claude/skills/goldband/bin/goldband-model-benchmark"
[ -x "$BIN" ] || BIN=".claude/skills/goldband/bin/goldband-model-benchmark"
