...
goldband's Chrome extension Side Panel shows browse activity — every command, result,
...
A "Session" tab in the goldband Chrome extension Side Panel that shows:
...
## What goldband builds (extension side)
