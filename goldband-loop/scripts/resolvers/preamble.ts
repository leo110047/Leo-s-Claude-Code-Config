 ...
 *
 * Telemetry data flow:
 *   1. Always: local JSONL append to ~/.goldband/analytics/ (inline, inspectable)
 *   2. If _TEL != "off" AND binary exists: goldband-telemetry-log for remote reporting
 */
...
//   T4: review, qa, qa-only, design-review, land-deploy
