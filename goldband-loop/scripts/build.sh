...
"$BUN_CMD" build --compile bin/goldband-global-discover.ts --outfile bin/goldband-global-discover
"$BUN_CMD" build --compile scripts/task-emission-schema.ts --outfile bin/goldband-task-emission
bash browse/scripts/build-node-server.sh
bash scripts/write-version-files.sh browse/dist/.version design/dist/.version make-pdf/dist/.version
chmod +x browse/dist/browse browse/dist/find-browse design/dist/design make-pdf/dist/pdf bin/goldband-global-discover bin/goldband-task-emission
rm -f .*.bun-build
