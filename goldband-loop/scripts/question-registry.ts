/**
 * Question Registry — typed schema for AskUserQuestion invocations across goldband.
 *
 * Purpose
 * -------
 ...
 *
 * Not every AskUserQuestion in goldband needs a registry entry right away. Skills
...
export interface QuestionDef {
  ...
  id: string;
  /** Skill that owns this question (must match a goldband skill directory name) */
  skill: string;
...
export const QUESTIONS = {
  ...
  // -----------------------------------------------------------------------
  // /goldband-upgrade — version upgrade
  // -----------------------------------------------------------------------
  'goldband-upgrade-inline': {
    id: 'goldband-upgrade-inline',
    skill: 'goldband-upgrade',
    category: 'approval',
    door_type: 'two-way',
    options: ['yes-upgrade', 'always-auto', 'not-now', 'never-ask'],
    description: "Upgrade goldband now? (Also: always auto-upgrade, snooze, or disable the prompt.)",
  },
  ...
  'preamble-telemetry-consent': {
    ...
    description: "Share usage data with goldband? community (recommended) / anonymous / off",
  },
  'preamble-proactive-behavior': {
    ...
    door_type: 'two-way',
    options: ['on', 'off'],
    description: "Let goldband proactively suggest skills based on conversation context?",
  },
  'preamble-routing-injection': {
    ...
    description: "Add goldband skill routing rules to CLAUDE.md?",
  },
  'preamble-vendored-migration': {
    ...
    description: "This repo has vendored goldband (deprecated) — migrate to team mode?",
  },
