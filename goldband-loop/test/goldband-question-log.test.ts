/**
 * bin/goldband-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'goldband-question-log');
...
describe('goldband-question-log — valid payloads', () => {
...
describe('goldband-question-log — rejected payloads', () => {
...
describe('goldband-question-log — injection defense', () => {
  const attacks = [
