...
- Save the report to .goldband/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.goldband', 'security-reports');
...
- Skip the preamble (goldband-update-check, telemetry, etc.) — go straight to the audit.
