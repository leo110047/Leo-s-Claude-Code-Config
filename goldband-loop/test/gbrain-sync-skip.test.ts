/**
 * Tests the split-engine SKIP semantics in bin/goldband-gbrain-sync.ts (plan D12).
 *
 ...
 * unchanged. This is the behavior that matters most for a broken local-db
...
describe("goldband-gbrain-sync — split-engine SKIP (plan D12)", () => {
