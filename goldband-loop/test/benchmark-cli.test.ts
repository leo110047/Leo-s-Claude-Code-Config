/**
 * goldband-model-benchmark CLI tests (offline).
 *
...
const BIN = path.join(ROOT, 'bin', 'goldband-model-benchmark');
...
describe('goldband-model-benchmark prompt resolution', () => {
