// AUTO-GENERATED from goldband/ios-qa/templates/StateServer.swift.template
...
public final class StateServer {
    ...
    private let logger = Logger(subsystem: "goldband.ios-qa", category: "StateServer")
    ...
    private init(port: UInt16 = 9999) {
        ...
        self.bootTokenPath = NSTemporaryDirectory() + "goldband-ios-qa.token"
    }
    ...
    public func start() {
        ...
        //    seconds.
        logger.notice("goldband-ios-qa-bootstrap token=\(self.bootToken, privacy: .public) port=\(self.port, privacy: .public) build=\(self.appBuildId, privacy: .public)")
