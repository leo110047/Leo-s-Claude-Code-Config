/**
 * Regression pin for #1346: goldband-memory-ingest must never call the
...
const SOURCE_PATH = join(import.meta.dir, "..", "bin", "goldband-memory-ingest.ts");
...
describe("goldband-memory-ingest — no put_page in active code (regression for #1346)", () => {
