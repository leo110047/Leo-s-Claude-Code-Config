/**
 * bin/goldband-developer-profile — subcommand behavior tests.
 *
 * Covers:
...
const BIN_DEV = path.join(ROOT, 'bin', 'goldband-developer-profile');
const BIN_LOG = path.join(ROOT, 'bin', 'goldband-question-log');

let tmpHome: string;

beforeEach(() => {
  tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), 'goldband-test-'));
});
...
describe('goldband-developer-profile --read', () => {
...
describe('goldband-developer-profile --migrate', () => {
...
describe('goldband-developer-profile tier calculation', () => {
...
describe('goldband-developer-profile --derive', () => {
...
describe('goldband-developer-profile --trace <dim>', () => {
...
describe('goldband-developer-profile --gap', () => {
...
describe('goldband-developer-profile --vibe', () => {
...
describe('goldband-developer-profile --check-mismatch', () => {
...
describe('goldband-developer-profile errors', () => {
...
describe('goldband-developer-profile --log-session (#1671 fix)', () => {
  ...
  test('silently skips invalid JSON input (matches goldband-timeline-log pattern)', () => {
