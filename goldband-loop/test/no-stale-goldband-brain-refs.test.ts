/**
 * Regression: no stale `goldband-brain-init`, `gbrain_sync_mode`, or
 * `~/.goldband-brain-remote.txt` references survive the v1.27.0.0 rename.
 *
 ...
 *
 * Allowlist: the migration script (`goldband-upgrade/migrations/v1.27.0.0.sh`)
...
const ALLOWLIST = [
  ...
  'goldband-upgrade/migrations/v1.27.0.0.sh',
  // Older migration scripts — historical references; these document past state.
  'goldband-upgrade/migrations/v1.17.0.0.sh',
  ...
  'test/goldband-upgrade-migration-v1_17_0_0.test.ts',
  ...
  'test/no-stale-goldband-brain-refs.test.ts',
...
describe('no stale goldband-brain refs (v1.27.0.0 rename)', () => {
