/**
 * goldband-gbrain-repo-policy — per-remote trust-tier policy store.
 *
 ...
 *
 * Each test uses a temp GOLDBAND_HOME so nothing leaks into the user's real ~/.goldband.
 */
...
const BIN = path.join(ROOT, 'bin', 'goldband-gbrain-repo-policy');
