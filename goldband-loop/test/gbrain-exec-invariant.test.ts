 ...
 * `bin/goldband-gbrain-sync.ts` or `bin/goldband-memory-ingest.ts` silently
 ...
 * `lib/goldband-memory-helpers.ts`, `bin/goldband-brain-context-load.ts`)
