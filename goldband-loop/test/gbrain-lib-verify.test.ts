/**
 * goldband-gbrain-supabase-verify + goldband-gbrain-lib.sh — Slice 3 of /setup-gbrain.
 *
 ...
 * skill template and by goldband-gbrain-supabase-provision. Validates var
...
const VERIFY = path.join(ROOT, 'bin', 'goldband-gbrain-supabase-verify');
...
describe('goldband-gbrain-supabase-verify', () => {
  const VALID =
...
describe('goldband-gbrain-lib.sh read_secret_to_env', () => {
