/**
 * Tests for bin/goldband-diff-scope — verifies scope signal detection.
 *
...
const SCRIPT = join(import.meta.dir, '..', 'bin', 'goldband-diff-scope');
