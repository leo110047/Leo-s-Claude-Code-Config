...
~/.claude/skills/goldband/bin/goldband-timeline-log '{"skill":"retro","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
~/.claude/skills/goldband/bin/goldband-question-log '{"skill":"retro","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
...
```bash
~/.claude/skills/goldband/bin/goldband-learnings-log '{"skill":"retro","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
```bash
DISCOVER_BIN=""
[ -x ~/.claude/skills/goldband/bin/goldband-global-discover ] && DISCOVER_BIN=~/.claude/skills/goldband/bin/goldband-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .claude/skills/goldband/bin/goldband-global-discover ] && DISCOVER_BIN=.claude/skills/goldband/bin/goldband-global-discover
