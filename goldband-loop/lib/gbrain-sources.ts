 ...
 *
 * Mirrors the bash logic in bin/goldband-gbrain-source-wireup:204-310 but in a form
 * importable by other TS callers (currently bin/goldband-gbrain-sync.ts; future
...
import { withErrorContext } from "./goldband-memory-helpers";
 ...
 * forensic logging to ~/.goldband/.gbrain-errors.jsonl.
 */
