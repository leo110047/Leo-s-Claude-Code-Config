/**
 * goldband browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__goldbandInspectorActive) return;
  window.__goldbandInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'goldband-inspector-highlight';
    ...
    tooltipEl.id = 'goldband-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'goldband-inspector-highlight' || target.id === 'goldband-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `goldband-inject-${id}`;
